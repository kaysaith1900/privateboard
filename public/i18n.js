...
When the room ___, raise an objection.`,
      ...
      ag_ws_title_needs: "Web search needs a Brave Search API key · click to configure",
...
当房间 ___ 时，要明确提出反对。`,
      ...
      migrate_body: "已应用 {count} 个新迁移 · 你已有的房间、董事、报告、设置都已保留。",
      migrate_body_one: "已应用 1 个新迁移 · 你已有的房间、董事、报告、设置都已保留。",
      ...
      ag_ws_enabled: "已开启",
      ag_ws_disabled: "已关闭",
      ag_ws_title_needs: "联网搜索需要 Brave Search API key · 点击配置",
      ...
      us_usage_agents: "{n} 个董事",
      us_usage_silent: "+ {n} 个董事尚未产生计费",
