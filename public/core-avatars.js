...
(function (root) {
  ...
  root.PB_CORE_AVATARS = {
    ...
    "value-investor": {
      model: "casual", hairStyle: "style8",
      accessory: "none",
      skin: "#f7d7b8", hair: "#8d6a45", brow: "#8d6a45",
      topStyle: "style7", bottomStyle: "street", top: "#6b3f4a", bottom: "#f2f2f2",
      browStyle: "default", tieStyle: "royal",
      beardStyle: "style9", beard: "#8d6a45", tie: "#19a974", eye: "#0d0d0d",
    },
    historian: {
    ...
    "user-empathy": {
      model: "classic", hairStyle: "style6", outfitStyle: "classic",
      accessory: "none",
      skin: "#f7d7b8", hair: "#6f4e37", brow: "#6f4e37", outfit: "#7a5a3b",
      browStyle: "default", tieStyle: "none",
      tie: "#6b3f4a", eye: "#0d0d0d",
    },
    "long-horizon": {
      model: "classic", hairStyle: "style9",
      accessory: "cap",
      skin: "#f1c27d", hair: "#6f4e37", brow: "#6f4e37",
      topStyle: "casual", bottomStyle: "street", top: "#4a6b52", bottom: "#f2f2f2",
      browStyle: "royal", tieStyle: "none",
      beardStyle: "style10", beard: "#6f4e37", tie: "#4a6b52", eye: "#0d0d0d",
    },
    phenomenologist: {
      model: "glasses", hairStyle: "street",
      accessory: "glasses",
      skin: "#8d5524", hair: "#b08d57", brow: "#e8cf9a",
      topStyle: "casual", bottomStyle: "street", top: "#3b5b78", bottom: "#1a1a1a",
      browStyle: "default", tieStyle: "xmas",
      beardStyle: "none", beard: "#e8cf9a", tie: "#d8392b", eye: "#0d0d0d",
    },
  };
